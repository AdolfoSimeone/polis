...
s.modSubmit = "Listo, próximo comentario";   //Ditto above
...
s.helpWhatDoIDo = "Haz clic en 'De acuerdo' o 'No de acuerdo' para votar en comentarios ajenos. Escribe una declaración (manténgalo a una sola idea). Invita a tus amigos a la discusión!";
s.writeCommentHelpText = "Si tu perspectiva no está representada ya, <strong>escriba</strong> una declaración!";
s.helpWriteListIntro = "Qué hace que una declaración sea exitosa?";
s.helpWriteListStandalone = "Idea única";
s.helpWriteListRaisNew = "Plantea nuevas perspectivas, experiencias o problemas";
s.helpWriteListShort = "Es clara, concisa y acorde a las reglas";
s.heresHowGroupVoted = "Así votó el Grupo {{GROUP_NUMBER}}:";
...
s.xOfthoseDisagreed = "de esos participantes no están de acuerdo";
s.opinionGroups = "Grupos de Opinión";

s.pctAgreed = "{{pct}}% están de acuerdo";
s.pctDisagreed = "{{pct}}% no están de acuerdo";
s.pctAgreedLong = "{{pct}}% de groupo que están de acuerdo con el comentario {{comment_id}}.";
s.pctAgreedOfGroup = "{{pct}}% de Grupo {{group}} están de acuerdo";
s.pctDisagreedOfGroup = "{{pct}}% de Grupo {{group}} no están de acuerdo";
s.pctDisagreedLong = "{{pct}}% de todos que votaron {{comment_id}} no están de acuerdo.";
s.pctAgreedOfGroupLong = "{{pct}}% de los del group {{group}} que votaron en el comentario {{comment_id}} están de acuerdo.";
s.pctDisagreedOfGroupLong = "{{pct}}% de los en el {{group}} que votaron por el comentario {{comment_id}} no están de acuerdo.";
...
s.tip = "Consejo:";
s.commentWritingTipsHintsHeader = "Cómo escribir una declaración";
...
s.noCommentsYetSoWrite = "Agregue una declaración para comenzar esta conversación.";
s.noCommentsYetSoInvite = "Comience esta conversación - invite más participantes o agregue una declaración.";
s.noCommentsYouVotedOnAll = "Ya votaste para todos los comentarios.";
s.noCommentsTryWritingOne = "Si tienes algo más para decir, escribe una declaración nueva.";
s.convIsClosed = "Esta conversación está cerrada";
s.noMoreVotingAllowed = "No puedes votar más.";
...
s.topic_good_03 = "Hay algo que está limitando la productividad?";
